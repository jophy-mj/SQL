...
INSERT INTO customer VALUES( 1, 'Rekha'),(2,'sina'),(3,'maria'),(4,'hello'),(5,'sani');
SELECT * FROM customer;
INSERT INTO item VALUES( 1, 'rice', 120),(2,'banana',50),(3,'handwash',60),(4,'cake',420),(5,'sweets',25);
INSERT INTO sale VALUES ( 10, '2020-10-01', 1, 1, 3), ( 11, '2020-10-01', 1, 3, 2),( 12, '2020-10-01', 1, 5, 7),   ( 13, '2018-10-01', 4, 4, 1),  ( 14, '2018-10-11', 4, 2, 2),  ( 15, '2018-09-29', 5, 1, 5),( 16, '2019-12-25', 3, 1, 5),( 17, '1995-06-21', 5, 4, 4),( 18,'2002-04-01', 4, 5, 5),( 19, '2020-02-12', 1, 2, 1);
select * from sale;
